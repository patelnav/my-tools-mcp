    ...
    <div className="p-4 max-w-4xl mx-auto">
      ...
      <div className="space-y-6">
        <section className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
          <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Select Tool</h2>
          <ToolSelector onSelect={handleToolSelect} isConnected={isConnected} vscode={vscode} />
        </section>
          ...
          {error ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{documentation.data.name}</h2>
            ...
            <p className="text-gray-500 dark:text-gray-400">Select a tool to view its documentation</p>
          )}
        </section>
      </div>
    </div>
